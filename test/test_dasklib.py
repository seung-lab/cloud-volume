...
from cloudvolume import dasklib
...
def test_roundtrip_3d():
    ...
    with du.tmpdir() as d:
        d = 'file://' + d
        dasklib.dask_to_cloudvolume(a, d)
        a2 = dasklib.dask_from_cloudvolume(d)
...
def test_roundtrip_rechunk_3d():
    ...
    with du.tmpdir() as d:
        d = 'file://' + d
        dasklib.dask_to_cloudvolume(a, d)
        a2 = dasklib.dask_from_cloudvolume(d, chunks=5)
...
def test_delayed_compute():
    ...
    with du.tmpdir() as d:
        d = 'file://' + d
        out = dasklib.dask_to_cloudvolume(a, d, compute=False)
